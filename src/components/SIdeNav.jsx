  ...
  return (
    <div className='text-white ml-2'>
        <div className='Heading flex gap-8 px-4 py-2 border-b '>
            ...
            <Link className='font-bold text-2xl  uppercase tracking-wider '>MoviezHuB</Link>
        </div>
        <div  className='Contents flex flex-col gap-5 mt-5 '>
            <div className='mt-5 flex items-center gap-3 rounded hover:cursor-pointer hover:bg-purple-600 transition-all duration-100 px-3 py-6'>
                <FaFire className='text-2xl' />
                <Link className='text-2xl font-semibold  capitalize'>Trending</Link>
            </div>
            <div className='mt-5 flex items-center gap-3 rounded hover:cursor-pointer hover:bg-purple-600 transition-all duration-100 px-3 py-6'>
                <RiSparklingLine className='text-2xl' />
                <Link className='text-2xl font-semibold  capitalize'>Popular</Link>
            </div>
            <div className='mt-5 flex items-center gap-3 rounded hover:cursor-pointer hover:bg-purple-600 transition-all duration-100 px-3 py-6'>

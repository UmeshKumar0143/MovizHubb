...
const Trending = () => {
  ...
  return movies.length > 0 ? (
    <div className="w-full text-white relative h-full  ">
      <div className="TopBar flex h-[10%] gap-4  pb-4 items-center mt-2 w-full ">
        ...
        <div className="Search_Bar   flex justify-center items-center w-[40%] lg:w-[60%]">
          <div className=" Search-Bar  text-white flex flex-col relative">
            <div className="Search w-full md:w-[40vh] sm:w-[30vh] lg:w-[90vh] xl:w-[120vh]  mt-3 gap-3 flex justify-center items-center">
        ...
        <div className="filter-div-1 hidden md:visible py-4 px-2 md:gap-5 gap-3 md:flex  w-[10%]  absoulute top-[10vh]  sm:w-[30%]">
          <div className="Select-Type flex  items-center gap-2">
            ...
            <select
              ...
              value={type}
            >
              <option className="font-semibold capitalize" value="all">
                All
              </option>
              <option className="font-semibold capitalize" value="movie">
                movies
              </option>
              <option className="font-semibold capitalize" value="tv">
                Tv Shows
              </option>
            </select>
          </div>
      ...
      <div className="Trending-Page mb-3 w-[120vh]  mt-4 ml-14 ">
        <div className="w-full absolute gap-2 left-2  flex items-center  pb-3">
          <div className="">
          <h1 className="hover:text-purple-500 text-left transition-all ease-in-out duration-75 text-zinc-200 text-2xl md:text-5xl  font-semibold uppercase">
            Trending
          </h1>
          </div>
          <div className="filter-div md:hidden  py-4 px-2 md:gap-5 gap-3 flex  w-[10%]  absoulute top-[10vh] sm:w-[30%]">
          <div className="Select-Type flex  items-center gap-2">
            ...
            <select
              onChange={(e) => settype(e.target.value)}
              className="bg-black px-1   py-1 capitalize"
              name="Type-Select"
              id="type"
              value={type}
            >
